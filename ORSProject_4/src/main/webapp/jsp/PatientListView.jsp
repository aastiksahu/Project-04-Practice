...
<%@page import="com.rays.model.PatientModel"%>
<%@page import="com.rays.controller.PatientListCtl"%>
...
<body>
	...
	<jsp:useBean id="bean" class="com.rays.bean.PatientBean"
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>Name :</b></label> <input
						...
						<%-- <label><b>Date Of Visit:</b></label> <input type="text"
						name="dateOfVisit" placeholder="Enter your visit date"
						...
						<label><b>Disease : </b></label> <%=HTMLUtility.getList("disease", String.valueOf(bean.getDisease()), map)%>&nbsp;
			...
			<table border="1" style="width: 100%; border: groove;">
				...
				<tr>
					...
					<td style="text-align: center;"><a
						href="<%=ORSView.PATIENT_CTL%>?id=<%=bean.getId()%>">Edit</a>
					</td>
				</tr>
